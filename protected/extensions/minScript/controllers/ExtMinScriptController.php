...
class ExtMinScriptController extends CExtController {
	...
	public function actionServe() {
        ...
        public function filterPrepareCss($filterChain) {
            $this->filterPrepareServe($filterChain);
        }
        ...
        public function filterPrepareJs($filterChain) {
            $this->filterPrepareServe($filterChain);
        }
	/**
	...
	public function filters() {
		return array('prepareServe + serve + js + css');
	}
